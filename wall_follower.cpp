...
{  
    ...
    if (scan_data_[FRONT] > 0.55) {
       if (scan_data_[LEFT_FRONT] < 0.43 && scan_data_[LEFT_BACK] < 0.43) {
          if (scan_data_[LEFT_FRONT] < 0.35 && scan_data_[FRONT_LEFT] < 0.35) {
       ...
       if (scan_data_[FRONT] < 0.5) { //too close to the front wall
           ...
           return;
       } else if (scan_data_[FRONT_LEFT] < 0.5 || scan_data_[FRONT_RIGHT] < 0.5 || scan_data_[LEFT_FRONT] < 0.5 || scan_data_[RIGHT_FRONT] < 0.5) { //when there is wall in front
